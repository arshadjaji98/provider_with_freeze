...
mixin _$PersonModel {
  ...
  List<String> get personName => throw _privateConstructorUsedError;
...
abstract class $PersonModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, int age, List<String> personName});
}
...
class _$PersonModelImpl implements _PersonModel {
  _$PersonModelImpl(
      {this.name = '', this.age = 0, final List<String> personName = const []})
  ...
  @JsonKey()
  final int age;
  final List<String> _personName;
  @override
  @JsonKey()
  List<String> get personName {
    if (_personName is EqualUnmodifiableListView) return _personName;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_personName);
  }

  @override
  String toString() {
    return 'PersonModel(name: $name, age: $age, personName: $personName)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._personName, _personName));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(
      runtimeType, name, age, const DeepCollectionEquality().hash(_personName));
...
abstract class _PersonModel implements PersonModel {
  factory _PersonModel(
      {final String name,
      final int age,
      final List<String> personName}) = _$PersonModelImpl;
